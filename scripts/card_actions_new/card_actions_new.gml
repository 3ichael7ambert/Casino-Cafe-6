...
function card_actions_new() {
	...
	if c_actions[0]  == true { 
	  ...
	  if (distance_to_point(movex,movey)) > speed { //if distance greater than speed
	   move_towards_point(movex,movey,20);           //move towards point
	     ...
	     ds_list_add(obj_control.color_list,spr_card_back);
	     speed = 0;                                  //speed = 0
	...
	//flipping animation
	if image_xscale > 0.1 and image_index == spr_card_back { //if image_xscale larger than 0 and card back
